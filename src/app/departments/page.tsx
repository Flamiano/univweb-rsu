...
import { Laptop, Settings, Briefcase, Cpu } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-md md:text-xl">
            Explore our programs in Technology, Engineering, and Business.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          ...
          <motion.div
            ...
            style={{
              backgroundImage: "url('/department/1.png')",
          ...
          >
            <div className="absolute inset-0 bg-[#0b2344]/80 group-hover:bg-[#0b2344]/70 transition duration-300 flex flex-col justify-center p-8">
              <Laptop className="w-10 h-10 mb-4 text-white" />
              ...
              <ul className="text-sm opacity-90 leading-relaxed space-y-1">
                ...
                <li>BSCpE - Computer Engineering</li>
              </ul>
            </div>
          </motion.div>
          ...
          <motion.div
            className="rounded-2xl overflow-hidden shadow-lg text-white relative group"
            style={{
              backgroundImage: "url('/department/2.png')",
              backgroundSize: "cover",
              backgroundPosition: "center",
              minHeight: "400px",
            }}
          ...
          >
            <div className="absolute inset-0 bg-[#0b2344]/80 group-hover:bg-[#0b2344]/70 transition duration-300 flex flex-col justify-center p-8">
              ...
              <ul className="text-sm opacity-90 leading-relaxed space-y-1">
                ...
                <li>BSChem - Chemical Engineering</li>
              </ul>
            </div>
          </motion.div>
          ...
          <motion.div
            className="rounded-2xl overflow-hidden shadow-lg text-white relative group"
            style={{
              backgroundImage: "url('/department/3.png')",
              backgroundSize: "cover",
              backgroundPosition: "center",
              minHeight: "400px",
            }}
          ...
          >
            <div className="absolute inset-0 bg-[#0b2344]/80 group-hover:bg-[#0b2344]/70 transition duration-300 flex flex-col justify-center p-8">
              ...
              <ul className="text-sm opacity-90 leading-relaxed space-y-1">
                <li>BSA - Accountancy</li>
                <li>BSBA - Business Administration</li>
                <li>BSREM - Real Estate Management</li>
              </ul>
            </div>
          </motion.div>
        </div>
      ...
      <section className="bg-gray-900 py-20 px-6 text-white">
        <div className="max-w-screen-xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-12 max-w-3xl mx-auto">
            Our university proudly fosters innovation, discipline, and
            excellence across key departments. Each hosts competitions,
            seminars, and hands-on events to strengthen academic and real-world
            expertise.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-800 rounded-2xl shadow-md p-8 hover:shadow-xl transition border-l-4 border-blue-500"
            >
              ...
              <p className="text-gray-300">
                Known for hosting annual coding hackathons, robotics contests,
                and system design expos—this department trains students in the
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-800 rounded-2xl shadow-md p-8 hover:shadow-xl transition border-l-4 border-green-500"
            >
              <div className="flex justify-center items-center mb-4">
              ...
              <p className="text-gray-300">
                The department promotes practical learning through inter-school
                engineering fairs, machine-building competitions, and
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-800 rounded-2xl shadow-md p-8 hover:shadow-xl transition border-l-4 border-yellow-400"
            >
              <div className="flex justify-center items-center mb-4">
                <Briefcase className="w-12 h-12 text-yellow-300" />
              </div>
              <h3 className="text-xl font-semibold mb-2 text-white">
                Business Department
              </h3>
              <p className="text-gray-300">
                With entrepreneurship bootcamps, marketing pitch battles, and
                leadership seminars, the Business Department cultivates
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(11, 35, 68, 0.85), rgba(11, 35, 68, 0.85)), url('/department/1.png')",
        }}
      >
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Discover Possibilities at Roel State University
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            At RSU, departments aren&apos;t just classrooms—they’re arenas for
            innovation, collaboration, and competition. Step into a future where
